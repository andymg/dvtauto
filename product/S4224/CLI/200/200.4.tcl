...
puts "TEST CASE 1.1.4"


config_frame -alias ixiap1 -frametype ethernetii -vlanmode singlevlan -vlanid $evc_vid -tpid $tpid -dstmac $ulf -framesize $frame_size
...
set getCaptured [check_capture -alias ixiap2 -dstmac $ulf -tpid $tpid -vlanid $evc_vid]
