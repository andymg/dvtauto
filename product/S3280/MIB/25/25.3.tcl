...
#Note : this test case is to test one source RX direction port  direction
...
puts "Tx is $Txget"
if { $Txget ==0 && $Rxget != 0 } {
    passed "Mirroring" "Mirroring source port RX direction test succeed"
} else { 
    failed  "Mirroring" "Mirroring source port RX direction test failed"
}
