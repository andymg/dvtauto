...
#Note : this test case is to test one source TX direction port  direction
...
mirror::setSourcePort $dut1 $port1 tx
...
puts "Tx is $Txget"
if { $Txget !=0 && $Rxget == 0 } {
    passed "Mirroring" "Mirroring source port TX direction test succeed"
} else { 
    failed  "Mirroring" "Mirroring source port TX direction test failed"
}
