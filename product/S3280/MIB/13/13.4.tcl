...
# 2. If the ingress arp packets didn't match the dynamic or static matching map ,Dropping invalid ARP packets
...
#test Arp Request packets from the Ingress port 
...
#.1  Arp Request packets that Matched the arp inspection static table from the Ingress port  test 
...
if { $getCaptured != 0 } {
    passed  "Arp Inspection" "Arp Request packets that matched static table  from the Ingress test succeed"
} else { 
    failed  "Arp Inspection" "Arp Request packets that matched static table from the Ingress test  failed"
}


#.2  Arp Request packets that didn't match sender mac address  ( match  vlan ,ip sender ip address and port) in static table from the Ingress test  
...
puts "get captured $getCaptured"
if { $getCaptured == 0 } {
    passed  "Arp Inspection" "Arp Request packets that didn't match vlan in  static table  from the Ingress test succeed"
} else { 
    failed  "Arp Inspection" "Arp Request packets that didn't match vlan in  static table  from the Ingress test  failed"
}


#.3  Arp Request packets that didn't sender ip address  ( match  vlan ,ip sender ip address and port) in static table from the Ingress test  
...
puts "get captured $getCaptured"
if { $getCaptured == 0 } {
    passed  "Arp Inspection" "Arp Request packets that didn't match sender ip address  in  static table  from the Ingress test succeed"
} else { 
    failed  "Arp Inspection" "Arp Request packets that didn't match sender ip address  in  static table  from the Ingress test  failed"
}

#.4  Arp Request packets that didn't match vlan ( match sender mac address ,ip sender ip address and port) in static table from the Ingress test  
