...
#Notes:
#The target of following test cases  is  test dynamic binding table work well or not 
...
if { $getCaptured != 0 } {
    passed  "Arp Inspection" "Arp Request packets that matched dynamic table  from the Ingress test succeed"
} else { 
    failed  "Arp Inspection" "Arp Request packets that matched dynamic table from the Ingress test  failed"
}
...
puts "get captured $getCaptured"
if { $getCaptured != 0 } {
    passed  "Arp Inspection" "Arp Reply packets that matched dynamic table  from the Ingress test succeed"
} else { 
    failed  "Arp Inspection" "Arp Reply packets that matched dynamic table from the Ingress test  failed"
}
