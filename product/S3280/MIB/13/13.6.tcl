...
#test Arp Reply packets from the Egress port 
...
#.1  Arp Reply packets that Matched the arp inspection static table from the Egress port  test 
...
if { $getCaptured != 0 } {
    passed  "Arp Inspection" "Arp Reply packets that matched static table  from the Egress test succeed"
} else { 
    failed  "Arp Inspection" "Arp Reply packets that matched static table from the Egress test  failed"
}


#.2  Arp Reply packets that didn't match sender mac address  ( match  vlan ,ip sender ip address and port) in static table from the Egress test  
...
puts "get captured $getCaptured"
if { $getCaptured == 0 } {
    passed  "Arp Inspection" "Arp Reply packets that didn't match vlan in  static table  from the Egress test succeed"
} else { 
    failed  "Arp Inspection" "Arp Reply packets that didn't match vlan in  static table  from the Egress test  failed"
}

#.3  Arp Reply packets that didn't sender ip address  ( match  vlan ,ip sender ip address and port) in static table from the Egress test  
...
puts "get captured $getCaptured"
if { $getCaptured == 0 } {
    passed  "Arp Inspection" "Arp Reply packets that didn't match sender ip address  in  static table  from the Egress test succeed"
} else { 
    failed  "Arp Inspection" "Arp Reply packets that didn't match sender ip address  in  static table  from the Egress test  failed"
}


#.4  Arp Reply packets that didn't match vlan ( match sender mac address ,ip sender ip address and port) in static table from the Egress test  
