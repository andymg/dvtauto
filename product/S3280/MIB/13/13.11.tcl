...
##################Arp inspection introduction###########################
#Notes:
#The target of following test cases  is  test  targert protocol address is 239.2.1.1   in arp reply packet
...
#.1 unexpected target protocol address 239.2.1.1  in arp reply packets  test 
...
if { $getCaptured == 0 } {
    passed "Arp Inspection" "Arp Inspection  error target protocol ip address 239.2.1.1  in arp Reply packets test succeed"
} else { 
    failed  "Arp Inspection" "Arp Inspection  error target protocol ip address 239.2.1.1  in arp Reply packets test failed"
}
