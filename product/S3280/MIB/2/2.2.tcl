...
#Notes:
#The target of this test case is to test if s-port can work well or not?
...
set desc "send untag packets to check receive packet type when Port Type is s-port"
