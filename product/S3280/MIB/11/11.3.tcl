...
#ipv4 multicast group address which is not in the range of the configuration.
...
if {$get_capture_p2==$get_capture_p3 && $get_capture_p3==$ixiap1tx && [llength $group_entry]==0} {
	passed "illegal ipv4 v1 multicast group test" "passed"
} else {
	failed "illegal ipv4 v1 multicast group test" "failed"
}
