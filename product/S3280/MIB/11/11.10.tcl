...
#Notes:
#The target of following test cases is to verify the dut will add mld v1 multicast address 
# and to check the traffic for this multicast address.
...
mvrenable true
after 1000
 channel_setting $vid del 225.0.0.1 225.0.0.10 TNDVT
...
set get_capture_p2 [check_capture -alias ixiap2 -dstmac "33 33 00 00 00 05" -srcmac "00 00 00 00 00 01"]
set get_capture_p3 [check_capture -alias ixiap3 -dstmac "33 33 00 00 00 05" -srcmac "00 00 00 00 00 01"]

if {$get_capture_p2==$ixiap1tx && $get_capture_p3 == 0 } {
 	passed "mldv1 traffic test" "works well"
 } else {
 	failed "mldv1 traffic test" "failed"
 }
