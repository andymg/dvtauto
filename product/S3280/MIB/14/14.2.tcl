...
if { $getCaptured == 0 } {
    passed  "Ip Source Guard" "Ip Source Guard  global mode  enable test succeed"
} else { 
    failed  "Ip Source Guard" "Ip Source Guard  global mode enable  test failed"
}

#2.global mode disable test 
IPSG::setglobalMode $dut1 disable
IPSG::setportMode $dut1  $port1 enable
IPSG::setportMode $dut1  $port2 disable
...
puts "get captured $getCaptured"
if { $getCaptured != 0 } {
    passed  "Ip Source Guard" "Ip Source Guard  global disable test succeed"
} else { 
    failed  "Ip Source Guard" "Ip Source Guard  global  mode disable  test failed"
}
